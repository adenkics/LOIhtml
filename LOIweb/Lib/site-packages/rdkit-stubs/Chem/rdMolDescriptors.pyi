...
class AtomPairsParameters(Boost.Python.instance):
    ...
    atomTypes: typing.ClassVar[rdkit.rdBase._vectunsigned int]  # value = <rdkit.rdBase._vectunsigned int object at 0x000001F9F7531740>
...
class DoubleCubicLatticeVolume(Boost.Python.instance):
    ...
    def __init__(self, mol: Mol, isProtein: bool = True, includeLigand: bool = False, probeRadius: float = 1.4, depth: int = 2, dotDensity: int = 0) -> None:
        """
            ...
            C++ signature :
                void __init__(struct _object * __ptr64,class RDKit::ROMol [,bool=True [,bool=False [,double=1.4 [,int=2 [,int=0]]]]])
        """
